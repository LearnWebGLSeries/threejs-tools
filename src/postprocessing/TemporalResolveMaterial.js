import { Vector2, Uniform, ShaderMaterial } from "../libs/three/current/three.module.js";
	...
	constructor() {
		super({
			...
			uniforms: {
				...
				blend: new Uniform(0.95),
				correction: new Uniform(0.1),
				exponent: new Uniform(1.75),
