import { Matrix3, ShaderMaterial, TangentSpaceNormalMap, Uniform, Vector2 } from "../libs/three/current/three.module.js"
...
export class NRMaterial extends ShaderMaterial {
	constructor() {
		super({ 
			defines: {
				USE_UV: "",
